...
import ReconciliationReports from "../screens/eic/ReconciliationReports";
...
const CustomDrawerContent = memo(function CustomDrawerContent(props) {
  ...
  const userInitial = useMemo(() => user?.name?.charAt(0) || "E", [user?.name]);
  const userName = useMemo(() => user?.name || "EIC Admin", [user?.name]);
      ...
      <View style={styles.drawerHeader}>
        <View style={styles.userInfo}>
          ...
          <View style={styles.userDetails}>
            ...
            <Text style={styles.userRole}>Engineer In-Charge</Text>
          </View>
        </View>
      </View>
...
const DrawerNavigator = memo(function DrawerNavigator() {
  ...
  return (
    <Drawer.Navigator
      initialRouteName="NetworkDashboard"
    ...
    >
      ...
      <Drawer.Screen
        ...
        options={{
          ...
          drawerIcon: ({ color }) => (
            <AppIcon icon="stockRequests" size={18} color={color} />
          ),
        }}
      />
      <Drawer.Screen
      ...
      {/* <Drawer.Screen
        ...
        options={{
          title: "Vehicle Queue",
          drawerIcon: ({ color }) => (
            <AppIcon icon="vehicleQueue" size={18} color={color} />
          ),
        }}
      /> */}
      <Drawer.Screen
        ...
        options={{
          ...
          drawerIcon: ({ color }) => (
            <AppIcon icon="driverApprovals" size={18} color={color} />
          ),
        }}
      />
      <Drawer.Screen
        ...
        options={{
          ...
          drawerIcon: ({ color }) => (
            <AppIcon icon="clusterManagement" size={18} color={color} />
          ),
        }}
      />
      {/* <Drawer.Screen
        ...
        options={{
          ...
          drawerIcon: ({ color }) => (
            <AppIcon icon="reconciliation" size={18} color={color} />
          ),
        }}
      /> */}
      {/* <Drawer.Screen
  ...
  return (
    ...
    >
      ...
      <Stack.Screen
        name="DriverApprovals"
        component={DriverApprovals}
        options={{ title: "Driver Approvals" }}
      />
      <Stack.Screen
        name="ClusterManagement"
        component={ClusterManagement}
        options={{ title: "Cluster Management" }}
      />
      <Stack.Screen
        name="ReconciliationReports"
        component={ReconciliationReports}
...
export default function EICNavigator() {
